		...
		e(function () {
			if (
				(a(),
					...
					e(".section-parallax-1").length &&
					(e(".section-parallax-1").prepend(
						'<div class="pbefore"></div><div class="pafter"></div>'
					),
						e(".section-parallax-1 .pbefore").jarallax({ speed: 0.85 }),
						e(".section-parallax-1 .pafter").jarallax({ speed: 0.85 })),
					e(".section-parallax-2").length &&
					(e(".section-parallax-2").prepend(
						'<div class="pbefore"></div><div class="pafter"></div>'
					),
						e(".section-parallax-2 .pbefore").jarallax({ speed: 0.85 }),
						e(".section-parallax-2 .pafter").jarallax({ speed: 0.85 })),
					e(".section-parallax-3").length &&
					(e(".section-parallax-3").prepend(
						'<div class="pbefore"></div><div class="pafter"></div>'
					),
						e(".section-parallax-3 .pbefore").jarallax({ speed: 0.85 }),
						e(".section-parallax-3 .pafter").jarallax({ speed: 0.85 })),
					e(".section-parallax-4").length &&
					(e(".section-parallax-4").prepend(
						'<div class="pbefore"></div><div class="pafter"></div>'
					),
						e(".section-parallax-4 .pbefore").jarallax({ speed: 0.85 }),
						e(".section-parallax-4 .pafter").jarallax({ speed: 0.85 })),
					e(".section-parallax-5").length &&
					(e(".section-parallax-5").prepend(
						'<div class="pafter"></div>'
					),
						e(".section-parallax-5 .pbefore").jarallax({ speed: 0.85 }),
						e(".section-parallax-5 .pafter").jarallax({ speed: 0.85 })),
					Splitting(),
					e(window).width() > 1200)
			)
				skrollr.init();
			...
			var s = e.cookie("skin");
			"dark" === s && e("body").removeClass("light-skin"),
				"light" === s && e("body").addClass("light-skin"),
				e("body").hasClass("light-skin") &&
				...
				e(".header").on("click", ".menu-btn", function () {
					if (e(this).hasClass("active"))
						e(this).removeClass("active"),
							...
							e(".menu-full-overlay").removeClass(
								"animate-active"
							),
							setTimeout(function () {
			...
			i.imagesLoaded(function () {
				i.isotope({ itemSelector: ".works-col", percentPosition: !0 });
			});
			var l = e(".m-gallery");
			l.imagesLoaded(function () {
				l.isotope({ itemSelector: ".col-lg-6", percentPosition: !0 });
			}),
